...
//  private long sender;
//
//  private AskResult(HttpResponse response) {
//    this.response = response;
////    this.channel = null;
//  }
//
//  private AskResult(long receiver, long sender) {
//    this.response = null;
...
//  }
//
//  public static AskResult result(HttpResponse response) {
//    return new AskResult(response);
//  }
//
